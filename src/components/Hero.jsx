    ...
    <section className="relative min-h-[88vh] flex items-center">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-2xl">
          <p className="text-emerald-300 font-semibold tracking-wide uppercase">ParadigmatiX</p>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-3">
            ...
            <Link to="/services" className="px-5 py-3 rounded-md bg-emerald-400 text-slate-900 font-semibold hover:bg-emerald-300 transition">
              Start Your Project
            </Link>
          </div>
        </div>
